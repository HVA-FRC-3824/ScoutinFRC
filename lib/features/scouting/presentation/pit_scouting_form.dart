    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildToggleCard(
            'Auto Fuel',
            'Scores Fuel during auto?',
            _formData['capabilities']['autoFuel'],
            (val) => setState(() => _formData['capabilities']['autoFuel'] = val),
          ),
          const SizedBox(height: 10),
          _buildToggleCard(
            'L1 Climb Auto',
            'Can L1 Climb in auto?',
            _formData['capabilities']['l1ClimbAuto'],
            (val) => setState(() => _formData['capabilities']['l1ClimbAuto'] = val),
          ),
          const SizedBox(height: 10),
          _buildToggleCard(
            'Climb',
            'Can climb during endgame?',
